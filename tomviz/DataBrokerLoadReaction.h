...
/// DataBrokerLoadReaction handles the "Import From DataBroker" action in tomviz.
/// On trigger, this will open a dialog where the user "drill down" to the
/// require variable, which is then loaded into Tomviz.
///
